...
\soln{Solution}
\begin{equation*}
	V=wlh=(20-2x)(12-2x)x=4x(x-6)(x-10)=4x^3-64x^2+240x \quad (0 < x < 6)
\end{equation*}
...
\begin{equation*}
	F(x)=
	\begin{cases}
		15(40-x) & \text{if } 0 \le x < 40\\
		0 & \text{if } 40 \le x \le 65 \\
		15(x-65) & \text{if } 65 < x \le 100 \\
	\end{cases}
\end{equation*}
...
\begin{equation*}
	E(x)=
	\begin{cases}
		10+0.06x & \text{if } 0 \le x \le 1200 \\
		10+0.07x & \text{if } 1200 < x \le 2000 
	\end{cases}
\end{equation*}
...
\begin{enumerate}
	...
	\begin{equation*}
		R(x)=
		\begin{cases}
			0 & \text{if } 0 \le x \le 10000 \\
			10 & \text{if } 10000 < x \le 20000 \\
			15 & \text{if } x > 20000
		\end{cases}
	\end{equation*}
	\imgsoln{1.1.75-ans.a}
	...
	\begin{equation*}
		...
		\begin{cases}
			0 & \text{if } 0 \le x \le 10000 \\
			0.1(x-10000) & \text{if } 10000 < x \le 20000 \\
			0.1(10000)+0.15(x-20000) & \text{if } x > 20000
		\end{cases}
		\Rightarrow
		\begin{cases}
			T(14000)=400 \\
...
\begin{enumerate}
	\item \qn{Even $f(-x)=f(x)$}
	\soln{Solution}
	\imgsoln{1.1.79-ans.a}
	
	\item \qn{Odd $f(-x)=-f(x)$}
	\soln{Solution}
	\imgsoln{1.1.79-ans.b}
\end{enumerate}
...
\begin{enumerate}
	\item \qn{Even $f(-x)=f(x)$}
	\soln{Solution}
	\imgsoln{1.1.80-ans.a}
	
	\item \qn{Odd $f(-x)=-f(x)$}
	\soln{Solution}
	\imgsoln{1.1.80-ans.b}
\end{enumerate}
...
\soln{Solution}
$$f(-x)=\frac{-x}{(-x)^2+1}=-(\frac{x}{x^2+1})=-f(x) \Rightarrow \text{Odd}$$
...
\soln{Solution}
$$f(-x)=\frac{(-x)^2}{(-x)^4+1}=\frac{x^2}{x^4+1}=f(x) \Rightarrow \text{Even}$$
...
\soln{Solution}
$$f(-x)=\frac{-x}{-x+1} \ne \pm f(x) \Rightarrow \text{Neither}$$
...
\soln{Solution}
$$f(-x)=-x|-x|=-x|x|=-f(x) \Rightarrow \text{Odd}$$
...
\soln{Solution}
$$f(-x)=1+3(-x)^2-(-x)^4=1+3x^2-x^4=f(x) \Rightarrow \text{Even}$$
...
\begin{enumerate}
	\item \qn{If $f$ and $g$ are both even functions}
	\soln{Solution}
	$$(f+g)(-x)=f(-x)+g(-x)=f(x)+g(x)=(f+g)(x) \Rightarrow \text{Even}$$
	
	\item \qn{If $f$ and $g$ are both odd functions}
	\soln{Solution}
	$$(f+g)(-x)=f(-x)+g(-x)=-f(x)-g(x)=-(f+g)(x) \Rightarrow \text{Odd}$$
	
	\item \qn{If $f$ is even function and $g$ is odd function}
	\soln{Solution}
	$$(f+g)(-x)=f(-x)+g(-x)=f(x)-g(x) \ne \pm(f+g)(x) \Rightarrow \text{Neither}$$
\end{enumerate}
...
\begin{enumerate}
	\item \qn{If $f$ and $g$ are both even functions}
	\soln{Solution}
	$$(fg)(-x)=f(-x)g(-x)=f(x)g(x)=(fg)(x) \Rightarrow \text{Even}$$
	...
	\item \qn{If $f$ is even function and $g$ is odd function}
	\soln{Solution}
	$$(fg)(-x)=f(-x)g(-x)=f(x)[-g(x)]=-(fg)(x) \Rightarrow \text{Odd}$$
\end{enumerate}
