...
\begin{enumerate}
	...
	\soln{Solution}
	The slope of the graph is $\frac{9}{5}$, representing that each of the Celsius temperatures increases, the Fahrenheit temperature increases by $\frac{9}{5}$. The $F$-intercept is 32 means that at 0$\degree C$, the Fahrenheit temperature is 32$\degree F$.
\end{enumerate}
