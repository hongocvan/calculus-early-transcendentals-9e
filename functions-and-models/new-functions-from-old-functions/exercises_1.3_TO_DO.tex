...
\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=1+x^2$$}

\soln{Solution}

\section*{Problem 10}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=(x+1)^2$$}

\soln{Solution}

\section*{Problem 11}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=|x+2|$$}

\soln{Solution}

\section*{Problem 12}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=1-x^3$$}

\soln{Solution}

\section*{Problem 13}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=\frac{1}{x}+2$$}

\soln{Solution}

\section*{Problem 14}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=-\sqrt{x}-1$$}

\soln{Solution}

\section*{Problem 15}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=\sin{4x}$$}

\soln{Solution}

\section*{Problem 16}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=1+\frac{1}{x^2}$$}

\soln{Solution}

\section*{Problem 17}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=2+\sqrt{x+1}$$}

\soln{Solution}

\section*{Problem 18}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=-(x-1)^2+3$$}

\soln{Solution}

\section*{Problem 19}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=x^2-2x+5$$}

\soln{Solution}

\section*{Problem 20}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=(x+1)^3+2$$}

\soln{Solution}

\section*{Problem 21}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=2-|x|$$}

\soln{Solution}

\section*{Problem 22}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=2-2\cos{x}$$}

\soln{Solution}

\section*{Problem 23}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=3\sin{\frac{1}{2}x}+1$$}

\soln{Solution}

\section*{Problem 24}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=\frac{1}{4}\tan(x-\frac{\pi}{4})$$}

\soln{Solution}

\section*{Problem 25}

\qn{Graph the function by hand, not by plotting points, bt by starting with the graph of one of the standard functions, and then applying the appropriate transformations $$y=|\cos(\pi x)|$$}
